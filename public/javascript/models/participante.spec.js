...
const makeSub = () => {
    const sut = makeParticipante("Bárbara Evans", "Modelo e filha de Monique Evans", "http://im.r7.com/record/files/2C96/1618/3F6E/369D/013F/72F6/B48C/5BBD/B%C3%A1rbaraEvans1.jpg", 69274684, 9446548);
    return { sut };
};
